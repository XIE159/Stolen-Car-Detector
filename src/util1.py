...
CSV_path = None
video_path = None
video_CSV_path = r'C:\Users\Student\Desktop\Program Output\test.csv'

# CSV File Strings
input_CSV_string = r'data\test csv file 2.csv'
video_CSV_string = r'C:\Users\Student\Desktop\Program Output\test.csv'
...
def parseFiles(video_path):
    ...
    # write results
    write_csv(results, r'output\test.csv')
    tk.messagebox.showinfo('Info!', 'The CSVs Have Been Written')

    addMissingData(r'output\test.csv')
